...
def get_config():
    ...
    parser.add_argument("--user_name", type=str, default='15155841423', help="[for wandb usage], to specify user's name for simply collecting training data.")
    ...
    # pretrained parameters
    # parser.add_argument("--model_dir", type=str, default="/home/szx/on-policy/onpolicy/scripts/results/VRX_USV/sydney_regatta/rmappo/vrx_3boats_navigation/models", help="by default None. set the path to pretrained model.")
    # parser.add_argument("--model_dir", type=str, default=None, help="by default None. set the path to pretrained model.")
    # parser.add_argument("--model_dir", type=str, default="/home/szx/on-policy/onpolicy/scripts/results/VRX_USV/sydney_regatta/mappo/vrx_2boats_navigation_old/models", help="by default None. set the path to pretrained model.")
    # parser.add_argument("--model_dir", type=str, default="/home/szx/on-policy/onpolicy/scripts/results/VRX_USV/sydney_regatta/mappo/vrx_2boats_navigation_safe_pinn/models", help="by default None. set the path to pretrained model.")
    parser.add_argument("--model_dir", type=str, default=None, help="by default None. set the path to pretrained model.")
    ...
    parser.add_argument("--use_pinn", action='store_true', default=False, help="启用 PINN 物理信息 Actor")
    parser.add_argument("--use_safe_pinn", action='store_true', default=False, help="启用带有障碍物检测的 Safe PINN")
    # parser.add_argument("--num_agents", type=int, default=2, help="环境中的智能体(船只)数量")
